...
![索引失效验证1啊啊啊啊啊啊啊啊啊啊啊啊索引失效验证1.png)

![索引失效验证1啊啊啊啊啊啊啊啊啊啊啊啊索引失效验证2.png)
...
![or查询走索引情况-两边字段有索引啊啊啊啊啊啊啊啊啊啊啊啊or查询走索引情况-两边字段有索引.png)
...
> 但是从5.1开始，MySQL引入了 index merge 优化技术，对同一个表可以使用多个索引分别进行条件扫描。
>
...
![内置函数验证-不使用内置函数啊啊啊啊啊啊啊啊啊啊啊啊内置函数验证-不使用内置函数.png)
...
![内置函数验证-内置函数啊啊啊啊啊啊啊啊啊啊啊啊内置函数验证-内置函数.png)
...
![反向选择之in啊啊啊啊啊啊啊啊啊啊啊啊反向选择之in.png)

```
explain select * from t_user where age not in (100, 50);
```

![反向选择之not_in啊啊啊啊啊啊啊啊啊啊啊啊反向选择之not_in.png)

### 七、索引字段可以为null，使用is null或is not null时，可能会导致索引失效

**第一种情况，表结构规定允许user_name 字段可以为null**

![null可以为空啊啊啊啊啊啊啊啊啊啊啊啊null可以为空.png)

```
explain select * from t_user where user_name is null;
```

![null可以为空校验之is_null啊啊啊啊啊啊啊啊啊啊啊啊null可以为空校验之is_null.png)

```
explain select * from t_user where user_name is not null;
```

![null可以为空校验之is_not_null啊啊啊啊啊啊啊啊啊啊啊啊null可以为空校验之is_not_null.png)

**第二种情况，表结构规定user_name 字段不可以为null**

![null不允许为null啊啊啊啊啊啊啊啊啊啊啊啊null不允许为null.png)

```
explain select * from t_user where user_name is null;
```

![null不允许为null之null啊啊啊啊啊啊啊啊啊啊啊啊null不允许为null之null.png)

```
explain select * from t_user where user_name is not null;
```

![null不允许为null之is_not_null啊啊啊啊啊啊啊啊啊啊啊啊null不允许为null之is_not_null.png)

### 八、隐式字符编码转换导致的索引失效

当两个表进行连接JOIN 是，如果两张表的字符编码不同，可能会导致索引失效。
...
![最左匹配之ab啊啊啊啊啊啊啊啊啊啊啊啊最左匹配之ab.png)

![最左匹配之ba啊啊啊啊啊啊啊啊啊啊啊啊最左匹配之ba.png)

```
explain select * from t_user where deposit = 5620.26;
```

![最左匹配之b啊啊啊啊啊啊啊啊啊啊啊啊最左匹配之b.png)
...
![优化器不走啊啊啊啊啊啊啊啊啊啊啊啊优化器不走.png)

```
explain select * from t_user where age > 99;
```

![优化器走啊啊啊啊啊啊啊啊啊啊啊啊优化器走.png)
